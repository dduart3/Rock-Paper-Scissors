...
},{"./utils/strings.js":"node_modules/gsap/utils/strings.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
_gsap.gsap.registerPlugin(_TextPlugin.TextPlugin);

var $d = document;
var $mainContainer = $d.querySelector(".main-container");
var $gameContainer = $d.querySelector(".game-container");
var $titleParaphs = $d.querySelectorAll(".title p");
var $log = $d.querySelector(".log");
var $logParaphs = $d.querySelectorAll(".log p");
var $options = $d.querySelectorAll(".options .option img");
var $message = $d.querySelector(".message");
var $playerScore = $d.querySelector(".player-score");
var $computerScore = $d.querySelector(".cpu-score");
var $gameFinishedContainer = $d.querySelector(".game-finished-container");
var $restartButton = $d.querySelector(".restart-button");
var playerScore;
var computerScore;

var onAnimationStarted = function onAnimationStarted() {
  ...
  var keyEvent = $d.addEventListener('keydown', start);
};

var startAnimation = function startAnimation() {
  var tl = _gsap.gsap.timeline({
    onComplete: onAnimationStarted
  }).from("body", {
    background: "black",
    duration: 1,
    delay: 5
  }).fromTo($titleParaphs[0], {
    autoAlpha: 0,
    x: -10
  }, {
    autoAlpha: 1,
    ...
    text: {
      value: "DUARTE INDUSTRIES UNIFIED OPERATING SYSTEM"
    },
    duration: 3,
    ease: "none"
  }).to($titleParaphs[1], {
    text: {
      value: "COPYRIGHT 2021 DUARTE INDUSTRIES"
    },
    duration: 3,
    ease: "none"
  }).to($titleParaphs[2], {
    ...
    text: {
      value: "> Initializing Duarte Industries(TM) Boot Agent"
    },
    duration: 3,
    ease: "none",
    delay: 1
    ...
    text: {
      value: "> Checking game files integrity"
    },
    duration: 3,
    ease: "none",
    delay: 2
    ...
    text: {
      value: "> System ready! Press Enter to start the game"
    },
    duration: 3,
    ease: "none",
    delay: 2
...
var displayMessage = function displayMessage(result, playerSelection, computerSelection) {
  var winMessages = ["Nice one!", "Yeahhh", "Woah, you're really good", "Keep going!", "What a beast!"];
  var lossMessages = ["Oh no", "Well, at least you tried", "Ooof, that's gonna hurt", "Nope, it didn't worked", "Try to get a doctor after this"];

  if (result === "tie") {
    _gsap.gsap.to(".message", {
      text: {
        value: "Round Draw"
      }
    });
    ...
    _gsap.gsap.to(".message", {
      text: {
        value: "".concat(winMessages[Math.floor(Math.random() * winMessages.length)], ", ").concat(playerSelection, " beats ").concat(computerSelection)
      }
    });
  } else {
    _gsap.gsap.to(".message", {
      text: {
        value: "".concat(lossMessages[Math.floor(Math.random() * lossMessages.length)], ", ").concat(computerSelection, " beats ").concat(playerSelection)
      }
    });
  }
};

var playRound = function playRound(playerSelection, computerSelection) {
  if (playerSelection === computerSelection) {
    displayMessage("tie");
  } else if (playerSelection === "rock" && computerSelection === "scissors" || playerSelection === "paper" && computerSelection === "rock" || playerSelection === "scissors" && computerSelection === "paper") {
    playerScore++;
    $playerScore.innerHTML = "PLAYER: ".concat(playerScore);
    displayMessage("win", playerSelection, computerSelection);
  } else {
    computerScore++;
    $computerScore.innerHTML = "COMPUTER: ".concat(computerScore);
    displayMessage("loss", playerSelection, computerSelection);
  }
};

var finishGame = function finishGame(result) {
  $d.removeEventListener("click", playGame);
  $mainContainer.classList.add("hidden");

  var finishAnimation = _gsap.gsap.to("body", {
    background: "black",
    duration: 2,
  ...
  var finishAnimation2 = _gsap.gsap.to(".game-finished-paraph", {
    text: {
      value: result
    },
    duration: 2,
    ...
    onComplete: function onComplete() {
      ...
      _gsap.gsap.fromTo(".restart-button", {
        autoAlpha: 0
      }, {
        autoAlpha: 1,
        duration: 5
...
var playGame = function playGame(e) {
  var playerSelection = playerPlay(e);
...
startAnimation();
},{"gsap":"node_modules/gsap/index.js","gsap/TextPlugin":"node_modules/gsap/TextPlugin.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
